...
set more off
psmatch2 wildcat o2 o2dem odem dem2 crude2 dem3 warcrude Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, kernel outcome(dincidence2COW) kerneltype(epan) bwidth(0.05) common logit
pstest         o2 o2dem odem dem2 crude2 dem3 warcrude Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, t(wildcat) sup( _support) 
...
* stratification with region FE
set more off
pscore wildcat o2 odem o2crude Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, pscore(p1) blockid(b1) logit comsup numblo(8)
	* Tb 10
...
*kernel matching
psmatch2 wildcat crude2 asiacrude odem odem2 crudewar  ocrude o3  Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, kernel outcome(d3_6incidence2COW) kerneltype(epan) bwidth(0.05) common logit
pstest         crude2 asiacrude odem odem2 crudewar  ocrude o3  Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, t(wildcat) sup( _support) 
	* Tb 10
...
* stratification with region FE
set more off
pscore wildcat o3 o2 ocrude owar crude3  crudeasia Ldemocracy LincidenceU Llogoilres Lcrude1990P africa southam asia oceania, pscore(p1) blockid(b1) logit comsup numblo(21)
	* Tb 10
...
* kernel with region FE	
psmatch2 wildcat o2dem o3 owar  crude3  dem3 dem2o Ldemocracy LincidenceU Llogoilres Lcrude1990P africa southam asia oceania, kernel outcome(dincidenceU) kerneltype(epan) bwidth(0.05) common logit
pstest         o2dem o3 owar  crude3  dem3 dem2o Ldemocracy LincidenceU Llogoilres Lcrude1990P africa southam asia oceania, t(wildcat) sup( _support) 
	* Tb 10
...
* stratification with region FE
set more off
pscore wildcat o2 ocrude warcrude Ldemocracy LincidenceU Llogoilres Lcrude1990P africa southam asia oceania, pscore(p1) blockid(b1) logit comsup numblo(7)
	* Tb 10
...
* kernel with region FE
set more off
psmatch2 wildcat asiawar dem2 dem3  wardem o2  o3 o2dem2 o3dem  Ldemocracy LincidenceU Llogoilres Lcrude1990P africa southam asia oceania, kernel outcome(d3_6incidenceU) kerneltype(epan) bwidth(0.05) common logit
pstest         asiawar dem2 dem3  wardem o2  o3 o2dem2 o3dem   Ldemocracy LincidenceU Llogoilres Lcrude1990P africa southam asia oceania, t(wildcat) sup( _support) 
	* Tb 10
...
* stratification with region FE
set more off
pscore wildcat  Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, pscore(p1) blockid(b1) logit comsup 
	* Tb 10
...
* kernel with region FE
psmatch2 wildcat  dem2 odem Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, kernel outcome(dmilexpSIPRI) kerneltype(epan) bwidth(0.05) common logit
pstest          dem2 odem Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, t(wildcat) sup( _support) 
	* Tb 10
...
* kernel with region FE		
psmatch2 wildcat oilsouth dem2war crude2 Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, kernel outcome(dmilexpSIPRI) kerneltype(epan) bwidth(0.05) common logit
pstest         oilsouth dem2war crude2 Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, t(wildcat) sup( _support) 
	* Tb 10
	xi: reg dmilexpSIPRI logvaldisc         wildcat Llogvaloilres LlogGDP_M Lecgrowth Llogpop_M       Ldemocracy i.numcode i.decade if _support==1 [pweight=_weight], robust cluster(numcode)
	* Tb A13
	xi: reg dmilexpSIPRI logvaldisc failure wildcat Llogvaloilres LlogGDP_M Lecgrowth Llogpop_M       Ldemocracy i.numcode i.decade if _support==1 [pweight=_weight], robust cluster(numcode)
...
set more off
pscore wildcat dem2 o2 Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, pscore(p1) blockid(b1) logit comsup numblo(10)
	* Tb 10	
	xi: reg dmilexpSIPRI logvaldisc         wildcat Llogvaloilres LlogGDP_M Lecgrowth Llogpop_M     Ldemocracy i.numcode i.decade i.b1, robust cluster(numcode)	
	* Tb A13
	xi: reg dmilexpSIPRI logvaldisc failure wildcat Llogvaloilres LlogGDP_M Lecgrowth Llogpop_M     Ldemocracy i.numcode i.decade i.b1, robust cluster(numcode)	
...
* kernel region FE
psmatch2 wildcat Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, kernel outcome(dmilexpSIPRI) kerneltype(epan) bwidth(0.05) common logit
pstest         Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, t(wildcat) sup( _support) 
	* Tb 10
	xi: reg dmilexpSIPRI logvaldisc         wildcat Llogvaloilres LlogGDP_M Lecgrowth Llogpop_M     Ldemocracy i.numcode i.decade if _support==1 [pweight=_weight], robust cluster(numcode)
	* Tb A13
	xi: reg dmilexpSIPRI logvaldisc failure wildcat Llogvaloilres LlogGDP_M Lecgrowth Llogpop_M     Ldemocracy i.numcode i.decade if _support==1 [pweight=_weight], robust cluster(numcode)
...
* STRATIFICATION with region FE
set more off
pscore wildcat  asiawar o2 o2crude dem2 dem2war crudewar crudedem demwar  Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, pscore(p1) blockid(b1) logit comsup numblo(9)
	* Tb A12
...
* kernel with region FE
psmatch2 wildcat odem o2dem o3 asiawar crudewar Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, kernel outcome(dcoup) kerneltype(epan) bwidth(0.05) common logit
pstest         odem o2dem o3 asiawar crudewar Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, t(wildcat) sup( _support) 
	* Tb A12
...
* stratification with region FE
set more off
pscore wildcat o2 odem dem2 Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, pscore(p1) blockid(b1) logit comsup
	* Tb A12
...
* kernel with region FE
psmatch2 wildcat dem2o o2 ocrude dem3 o2crude o2crude2 demcrude2 o3 Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, kernel outcome(periregular) kerneltype(epan) bwidth(0.05) common logit
pstest         dem2o o2 ocrude dem3 o2crude o2crude2 demcrude2 o3 Ldemocracy Lincidence2COW Llogoilres Lcrude1990P africa southam asia oceania, t(wildcat) sup( _support) 
	* Tb A12
